...
const ToolbarModals = memo(
  ({
    ...
    const handleConfirm = () => {
      ...
      setSuccessData({
        title: t("nodeToolbar.componentOverridden", { id: data.id }),
      });
    ...
    const handleCancel = () => {
      ...
      setSuccessData({ title: t("nodeToolbar.newComponentSaved") });
      setShowOverrideModal(false);
    };
      ...
      <>
        ...
        {showOverrideModal && (
          <ConfirmationModal
            ...
            cancelText={t("nodeToolbar.createNew")}
          ...
          >
            <ConfirmationModal.Content>
              <span>
                {t("nodeToolbar.replaceExistingComponent", {
