              ...
              <div className="w-full space-y-4 p-4">
                <div className="grid w-full items-center gap-2">
                  <span className="flex items-center text-sm">
                    {t("voiceAssistant.openaiApiKey")}
                    <span className="ml-1 text-destructive">*</span>
                    <ShadTooltip content={t("voiceAssistant.openaiRequiredTooltip")}>
                      <div>
                        <IconComponent
                          name="Info"
                          strokeWidth={2}
                    ...
                    <>
                      <InputComponent
                        ...
                        placeholder={getPlaceholder(
                          false,
                          t("voiceAssistant.enterOpenaiApiKey"),
                        )}
                        id="openai-api-key"
                        options={
                ...
                {showAllSettings && (
                  <>
                    <div className="grid w-full items-center gap-2">
                      <span className="flex items-center text-sm">
                        {t("voiceAssistant.elevenLabsApiKey")}
                        <ShadTooltip content={t("voiceAssistant.elevenLabsTooltip")}>
                          <div>
                            <IconComponent
                              name="Info"
                              strokeWidth={2}
                      ...
                      <InputComponent
                        ...
                        placeholder={getPlaceholder(
                          false,
                          t("voiceAssistant.enterElevenLabsApiKey"),
                        )}
