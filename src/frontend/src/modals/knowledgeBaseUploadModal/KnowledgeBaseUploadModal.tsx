...
import { getStepDescription, getStepTitle } from "./constants";
    ...
    <StepperModal
      ...
      title={
        form.isAddSourcesMode
          ...
          : getStepTitle(t, form.currentStep)
      }
      description={
        form.isAddSourcesMode && form.currentStep === 1
          ? t("knowledgeUpload.modalDescription")
          : getStepDescription(t, form.currentStep)
      }
      icon="Database"
      height={(() => {
        ...
        <StepperModalFooter
          ...
          submitLabel={
            form.isAddSourcesMode
              ...
              : t("knowledgeUpload.createButton")
          }
          helpLabel={
