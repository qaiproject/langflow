      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-col gap-2 pt-4">
          <Label className="text-sm font-medium">
            {t("knowledge.columns.embeddingModel")}{" "}
            <span className="text-destructive">*</span>
          </Label>
          {isAddSourcesMode ? (
            <div className="flex h-10 w-full items-center gap-2 rounded-md border border-input bg-muted px-3 py-2 text-sm">
              ...
              <span className="text-muted-foreground">
                {existingEmbeddingModel || t("knowledgeUpload.unknownModel")}
              </span>
            </div>
          ) : (
            <div
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col gap-2">
                  <Label className="text-xs text-muted-foreground">
                    {t("knowledgeUpload.sourcesLabel")}
                  </Label>
                  <DropdownMenu>
                      ...
                      >
                        <span className="flex items-center gap-2">
                          <ForwardedIconComponent
                            ...
                            className="h-4 w-4"
                          />
                          {t("knowledgeUpload.addSourcesButton")}
                        </span>
                        <ForwardedIconComponent
                          name="ChevronDown"
                          className="h-4 w-4"
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  >
                    {t("knowledgeUpload.chunkSizeLabel")}
                    <TooltipProvider>
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <span className="cursor-help">
                ...
                <div className="flex flex-col gap-2">
                  <Label
                    ...
                    className="flex items-center gap-1 text-xs text-muted-foreground"
                  >
                    {t("knowledgeUpload.chunkOverlapLabel")}
                    <TooltipProvider>
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <span className="cursor-help">
              ...
              <div className="flex flex-col gap-2">
                <Label
                  ...
                  className="flex items-center gap-1 text-xs text-muted-foreground"
                >
                  {t("knowledgeUpload.separatorLabel")}
                  <TooltipProvider>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <span className="cursor-help">
