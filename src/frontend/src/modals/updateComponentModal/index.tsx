    ...
    >
      ...
      <BaseModal.Content overflowHidden>
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-3 text-sm text-muted-foreground">
            {isMultiple ? (
              <p>{t("updateComponent.multipleDescription")}</p>
            ) : (
              <>
                <p>{t("updateComponent.singleDescription")}</p>
                <p>{t("updateComponent.latestVersionNote")}</p>
              </>
            )}
          </div>
          {isMultiple && (
      ...
      <BaseModal.Footer
        submit={{
          label: t(
            components.length > 1
              ? "updateComponent.submitPlural"
              : "updateComponent.submitSingle",
          ),
