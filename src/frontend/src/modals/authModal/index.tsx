            ...
            <div className="w-[70%] flex flex-col overflow-y-auto h-fit max-h-[400px] p-4">
              {authType === "apikey" && (
                <span className="flex flex-col items-start gap-1 text-mmd text-muted-foreground">
                  <p>
                    {t("mcp.apiKeyHelpPrefix")}{" "}
                    <CustomLink
                      className="text-accent-pink-foreground underline inline-block"
                      to="/settings/api-keys"
                    >
                      {t("mcp.apiKeyHelpLink")}
                    </CustomLink>{" "}
                    {t("mcp.apiKeyHelpMiddle")}{" "}
                    <span className="font-semibold">
                      {t("mcp.apiKeyHelpInstallJson")}
                    </span>
                    {t("mcp.apiKeyHelpEnd")}{" "}
                    <span className="font-semibold">
                      {t("mcp.apiKeyHelpJsonTab")}
                    </span>
                    .
                  </p>
                  {autoInstall && (
                    <p>
                      <span className="font-semibold">
                        {t("mcp.apiKeyHelpAutoInstallTitle")}
                      </span>{" "}
                      {t("mcp.apiKeyHelpAutoInstallBody")}
                    </p>
                  )}
                </span>
              )}
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="flex flex-col gap-2">
                      ...
                      <Input
                        id="oauth-host"
                        type="text"
                        placeholder={t("mcp.host").toLowerCase()}
