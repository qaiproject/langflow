    ...
    parameter && (
      <ShadTooltip
        content={
          disabled
            ? isTweaks
              ? t("parameterInput.cannotEnableConnectedInput")
              : t("parameterInput.cannotChangeConnectedVisibility")
            : isTweaks
              ? t("parameterInput.toggleFieldApiInput")
              : t("parameterInput.changeFieldVisibility")
        }
        styleClasses="z-50"
      >
