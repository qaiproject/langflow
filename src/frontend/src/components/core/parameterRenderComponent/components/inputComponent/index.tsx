...
export default function InputComponent({
  ...
  const inputPlaceholder = placeholder ?? t("common.typeSomething");
  const resolvedOptionsPlaceholder =
    optionsPlaceholder ?? t("common.searchOptions");
      ...
      {isForm ? (
        <Form.Control asChild>
          <Input
            ...
            placeholder={
              password && editNode ? t("parameterInput.key") : inputPlaceholder
            }
            onChange={(e) => {
