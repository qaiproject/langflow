...
const AudioButton = ({
  ...
  const getTooltipContent = () => {
    if (!isSupported) return t("playground.voiceInputUnsupported");
    if (isRecording) return t("playground.stopRecording");
    if (isProcessing) return t("playground.processing");
    return t("playground.voiceInput");
  };
